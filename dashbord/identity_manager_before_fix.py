...
class IdentityManager:
    ...
    def _resolve(self, obs: TrackObservation, emb: Optional[Embedding],
        ...
        if vote.verdict in (Verdict.NEW, Verdict.AMBIGUOUS):
        # Warm memory is minutes or hours old, so motion says nothing
        # useful about it. If HOT is inconclusive, WARM gets a chance to
        # recover the returning visitor using appearance alone.
